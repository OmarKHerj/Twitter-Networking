...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".edit").forEach(editButton => {
        editButton.onclick = () => {
            ...
            `<button form="edit-post${postId}" type="submit" class="edit btn btn-sm btn-outline-primary align-top rounded">Save</button>`
            editForm.innerHTML = 
            `<form id="edit-post${postId}">
            <div class="form-floating">
            <textarea required maxlength="300" id="edit-post" class="form-control" name="content">${contentField.innerHTML}</textarea>
